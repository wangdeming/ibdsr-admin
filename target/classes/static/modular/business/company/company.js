...
Company.initColumn = function () {
    return [
        ...
        {title: '企业人数', field: 'empNum',align: 'center', valign: 'middle'},
        ...
        {title: '操作', field: '',align: 'center', valign: 'middle',
            formatter: function (value, row, index) {
                return ''
                    + '<a style="margin-right: 15px;" onclick="Company.checkDetail('+row.id+')">查看</a>'
                    + '<a style="margin-right: 15px;" onclick="Company.export('+row.id+')">导出</a>'
            }
        },
    ];
};
