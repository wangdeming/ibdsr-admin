...
import cn.ibdsr.core.exception.CheckDtoException;
...
import static cn.ibdsr.core.support.HttpKit.getIp;
import static cn.ibdsr.core.support.HttpKit.getRequest;
...
public class GlobalExceptionHandler {
     ...
     * @author fengshuonan
     */
    @ExceptionHandler(CheckDtoException.class)
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public ErrorTip checkError(CheckDtoException e) {
        return new ErrorTip(e.getCode(),e.getMessage());
    }
    /**
     * fastdfs校验时异常
    ...
    @ResponseStatus(HttpStatus.OK)
    @ResponseBody
    public ErrorTip fastdfsError(FastdfsException e) {
        return new ErrorTip(e.getCode(),e.getMessage());
    }
