...
public class CompanyDTO extends BaseDTO {
     ...
     * 企业创立时间
     */
	@Verfication(name = "成立时间", notNull = true)
	@DateTimeFormat(pattern = "yyyy-MM-dd")
	private Date setTime;
    /**
     * 企业人数
     */
	@Verfication(name = "企业人数", notNull = true, max = 9999, regx = {RegUtil.NUMBER})
	private Integer empNum;
    /**
     * 主营业务
     */
	@Verfication(name = "主营业务", notNull = true, maxlength = 300)
     ...
     * 电子邮箱
     */
	@Verfication(name = "电子邮箱", notNull = true, regx = {CheckUtil.EMAIL, "格式有误"})
