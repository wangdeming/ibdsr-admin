...
public class NewsServiceImpl extends AbstractBaseService<NewsDTO, NewsInfo> implements INewsService {
    ...
    @Override
    public List<Map<String, Object>> list(Page<Map<String, Object>> page, String condition, Integer newsType, Integer isPublish) {
        page.setOpenSort(false);
        List<Map<String, Object>> list = newsDao.list(page, condition, newsType, isPublish, page.getOrderByField(), page.isAsc());
        return list;
    }
     ...
     */
    @Override
    public List<JSONObject> indexGetList(Page<JSONObject> page, Integer newsType) {
        return newsDao.indexGetList(page, newsType);
    }
