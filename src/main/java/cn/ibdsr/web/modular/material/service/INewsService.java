...
public interface INewsService extends BaseService<NewsDTO, NewsInfo> {
     ...
     * @return
     */
    List<Map<String,Object>> list(Page<Map<String,Object>> page, String condition, Integer newsType, Integer isPublish);
     ...
     * @return
     */
    List<JSONObject> indexGetList(Page<JSONObject> page, Integer newsType);
