...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("D:\\ideaSpace\\area-admin\\src\\main\\java");//这里写你自己的java目录
        gc.setFileOverride(false);//是否覆盖
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("zhanglin");
        ...
        dsc.setUrl("jdbc:mysql://dev.ibdsr.cn:13306/area?autoReconnect=true&useUnicode=true&characterEncoding=utf8");
        ...
        //设置生成的表
        strategy.setInclude(new String[]{"area", "area_image", "city", "res_type"});
