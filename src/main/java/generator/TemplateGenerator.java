...
public class TemplateGenerator {
    ...
    public static void main(String[] args) throws IOException {
        ...
        contextConfig.setBizChName("简历管理");
        contextConfig.setBizEnName("resume");
        contextConfig.setModuleName("hire");
        contextConfig.setProjectPath("E:\\project\\研究院官网项目\\ibdsr-admin");
